<?php if ($this['config']->get('article_style')=='tm-article-blog') : ?>
 ...
 <?php if (have_posts()) : ?>
    ...
    <article class="uk-article" data-permalink="<?php the_permalink(); ?>">
        ...
        <?php if (has_post_thumbnail()) : $post_image = wp_get_attachment_image_src( get_post_thumbnail_id() ); ?>
        <div class="uk-cover-background tm-featured-image" style="background-image:url(<?php echo $post_image[0]; ?>);"></div>
        <?php endif; ?>
