            ...
            <li>
                ...
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-controls">
                        ...
                        <p class="uk-form-controls-condensed" ng-if="widget.data.nav == 'thumbnails'">
                            <label><input type="checkbox" ng-model="widget.data['thumbnail_title']"> {{'Show item title under thumbnail.' | trans}}</label>
                        </p>
                    </div>
                </div>
            ...
            <li>
                ...
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-controls">
                        ...
                        <p class="uk-form-controls-condensed" ng-if="widget.data.media_align == 'top' || widget.data.media_align == 'bottom' || widget.data.media_align == 'last'">
                            <label>
