                ...
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-controls">
                        <select id="wk-nav" class="uk-form-width-medium" ng-model="widget.data['nav']">
                            ...
                            <option value="both">{{'Icon and title' | trans}}</option>
                        </select>
                    </div>
                </div>
            ...
            <li>
                ...
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-controls">
                        ...
                        <p class="uk-form-controls-condensed">
                            <label><input type="checkbox" ng-model="widget.data['title_overlay']"> {{'Place title on top of media' | trans}}</label>
                        </p>
                    </div>
                </div>

                <div class="uk-form-row">
                    <label class="uk-form-label" for="wk-text-width">{{'Content Width' | trans}}</label>
                    <div class="uk-form-controls">
                        <select id="wk-text-width" class="uk-form-width-medium" ng-model="widget.data['content_width']">
                            <option value="1-1">100%</option>
                            <option value="9-10">90%</option>
                            <option value="5-6">85%</option>
