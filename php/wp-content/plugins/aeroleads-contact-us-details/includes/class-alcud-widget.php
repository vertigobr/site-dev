...
class Alcud_Widget extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'alcud-widget';
	...
	public function __construct() {
		...
		parent::__construct(
			...
			__( 'AeroLeads Contact Us Details', $this->get_widget_slug() ),
			array(
				'classname'  => $this->get_widget_slug().'-class',
				'description' => __( 'AL-CUD displays contact details in sidebar', $this->get_widget_slug() )
				)
			);
	...
	public function widget( $args, $instance ) {
		...
		$active_widget = $wpdb->get_var( "SELECT widget_type FROM $table_name WHERE id = 1");
		...
		if($active_widget == "2"){
			include( plugin_dir_path( dirname( __FILE__ ) ) . 'widget/views/widget2.php' );
		}
...
add_action( 'widgets_init', create_function( '', 'register_widget("Alcud_Widget");' ) );
